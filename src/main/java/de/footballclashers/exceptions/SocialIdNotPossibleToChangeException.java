...
public class SocialIdNotPossibleToChangeException extends RuntimeException{
	private static final long serialVersionUID = 1L;
	private String keyMessage = null;
	private String extraMesaage = null;
	
	public SocialIdNotPossibleToChangeException(String keyMessage,String extraMesaage){
		super();
